...
export const metadata = {
  title: "Careers - Swastik",
  description: "Join our team and build your career with Swastik. Explore exciting opportunities and grow with us.",
}
      ...
      <section className="relative bg-gradient-to-br from-green-800 via-lime-700 to-green-600 text-white py-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-lime-100 leading-relaxed mb-8">
      ...
      <section id="why-join-us" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Swastik?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-600 to-lime-500 rounded-full mb-6">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <p className="text-lg text-lime-100 leading-relaxed">
                  At Swastik, we foster a culture of innovation, collaboration, and continuous learning. Our team is
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-r from-green-600 to-lime-500 rounded-full opacity-20"></div>
