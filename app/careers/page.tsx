...
export const metadata = {
  ...
  description:
    "Join our team and build your career with Swastik Holding Private Ltd. Explore exciting opportunities and grow with us.",
}
...
export default async function CareersPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-emerald-700 via-teal-700 to-cyan-700 text-white py-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#open-positions"
                className="inline-flex items-center px-8 py-4 bg-white text-teal-600 font-semibold rounded-full hover:bg-gray-100 transition-colors shadow-lg"
              >
                View Open Positions
              </a>
              <a
                href="#why-join-us"
                className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-teal-600 transition-colors"
              >
                Why Join Us?
              </a>
            </div>
          ...
          {jobs.length > 0 ? (
            ...
            <p className="text-sm text-gray-500 mt-2">
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-2xl font-semibold text-gray-900 mb-4">Didn't find the role you were looking for?</h3>
                <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                  Leave your CV in our talent pool — we’ll contact you when a fitting role opens up.
                </p>
                <a
                  href="/careers/apply"
                  className="inline-flex items-center px-8 py-4 bg-emerald-600 text-white font-semibold rounded-full hover:bg-emerald-700 transition-colors shadow-lg"
                >
                  Send Your Resume
                </a>
              </div>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                We're not actively hiring at the moment, but we’d still love to hear from you!
              </p>
              <a
                href="/careers/apply"
                className="inline-flex items-center px-8 py-4 bg-emerald-600 text-white font-semibold rounded-full hover:bg-emerald-700 transition-colors shadow-lg"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <p className="text-lg text-teal-100 leading-relaxed">
                  At Swastik Holding Private Ltd, we foster a culture of innovation, collaboration, and continuous learning.
                </p>
                <p className="text-lg text-teal-100 leading-relaxed">
                  We support professional growth, personal balance, and meaningful impact through our projects.
                </p>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-r from-emerald-600 to-cyan-600 rounded-full opacity-20"></div>
              <div className="absolute -top-6 -left-6 w-24 h-24 bg-gradient-to-r from-teal-600 to-emerald-600 rounded-full opacity-20"></div>
            </div>
          </div>
        </div>
      </section>
