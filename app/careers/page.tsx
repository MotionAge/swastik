...
export const metadata = {
  title: "Careers - ABC Company",
  description: "Join our team and build your career with ABC Company. Explore exciting opportunities and grow with us.",
}
...
export default async function CareersPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
<section className="relative bg-gradient-to-br from-emerald-800 via-teal-700 to-cyan-700 text-white py-24">
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <a
          href="#open-positions"
          className="inline-flex items-center px-8 py-4 bg-white text-emerald-600 font-semibold rounded-full hover:bg-gray-100 transition-colors shadow-lg"
        >
          View Open Positions
        </a>
        <a
          href="#why-join-us"
          className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-emerald-600 transition-colors"
        >
          Why Join Us?
        </a>
      </div>
...
<section id="why-join-us" className="py-20 bg-white">
  <div className="container mx-auto px-4">
    <div className="text-center mb-16">
      <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose ABC Company?</h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
      {benefits.map((benefit, index) => (
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-emerald-600 to-teal-500 rounded-full mb-6">
  ...
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="relative">
        ...
        <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-r from-emerald-600 to-lime-500 rounded-full opacity-20"></div>
        <div className="absolute -top-6 -left-6 w-24 h-24 bg-gradient-to-r from-cyan-600 to-emerald-400 rounded-full opacity-20"></div>
      </div>
    </div>
  </div>
</section>
